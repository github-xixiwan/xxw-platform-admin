package com.xxw.platform.frame.web.core.error;
...
public class CustomErrorAttributes extends DefaultErrorAttributes {
    ...
    public Map<String, Object> getErrorAttributes(WebRequest webRequest, ErrorAttributeOptions attributeOptions) {
        ...
        if (status.equals(HttpStatus.HTTP_NOT_FOUND)) {
            Map<String, Object> customAttrs = BeanUtil.beanToMap(new ErrorResponseData<>(DefaultBusinessExceptionEnum.NOT_FOUND.getErrorCode(), DefaultBusinessExceptionEnum.NOT_FOUND.getUserTip()));
