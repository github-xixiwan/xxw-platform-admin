package com.xxw.platform.core.error;
...
import com.xxw.platform.frame.common.exception.enums.defaults.DefaultBusinessExceptionEnum;
import com.xxw.platform.frame.common.pojo.response.ErrorResponseData;
import com.xxw.platform.frame.common.util.ExceptionUtil;
import com.xxw.platform.frame.common.util.HttpServletUtil;
import com.xxw.platform.frame.common.util.ProjectUtil;
import com.xxw.platform.frame.common.util.ResponseRenderUtil;
...
public class GlobalExceptionHandler {
    ...
    public String authError(AuthException authException, HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        if (AuthExceptionEnum.AUTH_EXPIRED_ERROR.getErrorCode().equals(errorCode)) {
            ...
            if (HttpServletUtil.getNormalRequestFlag(request)) {
                ...
                // 其他请求或者是ajax请求
                response.setHeader("Xxw-Session-Timeout", "true");
    ...
    private ErrorResponseData<?> renderJson(String code, String message, Throwable throwable) {
        if (ObjectUtil.isNotNull(throwable)) {
            ...
            ExceptionUtil.fillErrorResponseData(errorResponseData, throwable, ProjectConstants.ROOT_PACKAGE_NAME);
