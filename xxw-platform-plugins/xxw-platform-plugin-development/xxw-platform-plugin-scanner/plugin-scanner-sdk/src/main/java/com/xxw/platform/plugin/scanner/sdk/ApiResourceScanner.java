...
import com.xxw.platform.frame.common.util.AopTargetUtils;
...
import com.xxw.platform.plugin.scanner.api.context.MetadataContext;
...
import com.xxw.platform.plugin.scanner.api.factory.ClassMetadataFactory;
import com.xxw.platform.plugin.scanner.api.holder.IpAddrHolder;
import com.xxw.platform.plugin.scanner.api.pojo.resource.FieldMetadata;
import com.xxw.platform.plugin.scanner.api.pojo.resource.ParameterMetadata;
...
import com.xxw.platform.plugin.scanner.api.util.MethodReflectUtil;
...
public class ApiResourceScanner implements BeanPostProcessor {
    ...
    private ResourceDefinition createDefinition(Class<?> controllerClass, Method method, Annotation apiResource) {
        ...
        int controllerIndex = className.indexOf("Controller");
        if (controllerIndex == -1) {
            throw new ScannerException(ScannerExceptionEnum.ERROR_CONTROLLER_NAME, controllerClass.getName());
        }
